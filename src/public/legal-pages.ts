...
export function renderTermsPage(): string {
  return legalLayout("Terms of Service", /* html */ `
    ...
    <p>You are solely responsible for compliance with all applicable telecommunications and data protection laws, including but not limited to:</p>
    <ul>
      <li><strong>TCPA</strong> (Telephone Consumer Protection Act) — prior express consent for automated calls/texts in the US</li>
      <li><strong>FCC AI Voice Call Rules</strong> — the FCC's February 2024 ruling classifies AI-generated voice calls as "artificial" under the TCPA, requiring prior express consent and disclosure</li>
      <li><strong>State Robocall Laws</strong> — many states impose additional requirements on automated and AI-generated calls, including mandatory disclosure and registration</li>
      <li><strong>Caller ID Accuracy</strong> — you must ensure all outbound calls display accurate caller ID information in compliance with the Truth in Caller ID Act</li>
    ...
    <p>The Service provides compliance tools (DNC checking, TCPA time restrictions, consent tracking, content filtering, AI disclosure) as aids, but you bear ultimate responsibility for legal compliance. These tools do not guarantee compliance and are not a substitute for legal counsel.</p>
    ...
    <h2>11. AI-Specific Terms</h2>
    <p>The Service enables AI agents to make phone calls, send messages, and conduct conversations. You acknowledge and agree:</p>
    <ul>
      <li><strong>AI Communication Responsibility:</strong> All communications made by AI agents through your account are your responsibility, regardless of whether the content was generated by your AI or the platform's built-in AI features</li>
      <li><strong>AI Disclosure:</strong> The Service includes an AI disclosure feature that announces calls are AI-generated. Disabling this feature transfers full legal liability for non-disclosure to you</li>
      <li><strong>AI Agent Monitoring:</strong> You are responsible for monitoring and supervising your AI agents' behavior, including the content they generate during voice calls and messages</li>
      <li><strong>Robocall Prohibition:</strong> You may not use the Service to make robocalls (pre-recorded or AI-generated voice calls) without prior express consent as required by the TCPA and applicable state laws</li>
      <li><strong>No Guarantee of AI Behavior:</strong> The platform does not guarantee that AI-generated content will comply with all laws. You must implement appropriate safeguards and oversight</li>
    </ul>

    <h2>12. Limitation of Liability</h2>
    <p>TO THE MAXIMUM EXTENT PERMITTED BY LAW, THE SERVICE IS PROVIDED "AS IS" WITHOUT WARRANTIES OF ANY KIND, EXPRESS OR IMPLIED. WE SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, INCLUDING LOSS OF PROFITS, DATA, OR BUSINESS OPPORTUNITIES.</p>
    <p>WITHOUT LIMITING THE FOREGOING, WE EXPRESSLY DISCLAIM LIABILITY FOR:</p>
    <ul>
      <li>Content generated by AI agents during calls or messages</li>
      <li>TCPA, robocall, or AI disclosure violations resulting from your use of the Service</li>
      <li>Regulatory fines or penalties imposed on you by any government authority</li>
      <li>Claims by third parties who received AI-generated communications through your account</li>
      <li>Damages arising from your decision to disable AI disclosure or other compliance features</li>
    </ul>
    ...
    <p>You agree to indemnify, defend, and hold harmless 95percent.ai, its affiliates, officers, directors, employees, and agents from and against any and all claims, liabilities, damages, losses, costs, and expenses (including reasonable attorneys' fees) arising from or related to:</p>
    <ul>
      <li>Your use of the Service, including all communications made through your account</li>
      <li>AI-generated content transmitted via the platform</li>
      <li>Robocall or automated calling violations</li>
      <li>Failure to disclose AI-generated calls to recipients</li>
      <li>TCPA, FCC, GDPR, CAN-SPAM, CASL, or other regulatory violations</li>
      <li>Do Not Call list violations</li>
      <li>Failure to obtain or maintain required consent</li>
    ...
    <p>Before filing any formal dispute, you agree to contact us at <a href="mailto:legal@95percent.ai">legal@95percent.ai</a> and attempt to resolve the dispute informally for at least 30 days.</p>
    <h3>14.2 Binding Arbitration</h3>
    <p>If we cannot resolve a dispute informally, you and 95percent.ai agree to resolve any dispute, claim, or controversy arising from or relating to these Terms or the Service through binding arbitration administered by the American Arbitration Association (AAA) under its Commercial Arbitration Rules. The arbitration will be conducted in English, in Delaware, USA (or remotely at the arbitrator's discretion).</p>
    <h3>14.3 Class Action Waiver</h3>
    <p>YOU AND 95PERCENT.AI AGREE THAT EACH MAY BRING CLAIMS AGAINST THE OTHER ONLY IN YOUR OR ITS INDIVIDUAL CAPACITY, AND NOT AS A PLAINTIFF OR CLASS MEMBER IN ANY PURPORTED CLASS OR REPRESENTATIVE ACTION. The arbitrator may not consolidate more than one person's claims and may not otherwise preside over any form of representative or class proceeding.</p>
    <h3>14.4 Exceptions</h3>
    <p>Either party may seek injunctive relief in any court of competent jurisdiction to prevent imminent harm. Small claims court actions are also exempt from arbitration.</p>
    ...
    <p>These Terms are governed by the laws of the State of Delaware, USA, without regard to conflict of law principles. Subject to the arbitration provision above.</p>
...
export function renderAupPage(): string {
  return legalLayout("Acceptable Use Policy", /* html */ `
    ...
    <h3>2.4 AI-Specific Prohibitions</h3>
    <ul>
      <li>Make AI-generated voice calls without disclosing they are AI-generated</li>
      <li>Program AI agents to deny being AI when asked directly</li>
      <li>Use AI agents to impersonate specific real individuals</li>
      <li>Disable AI disclosure features without implementing equivalent disclosure</li>
      <li>Use AI to generate calls that circumvent robocall regulations</li>
    </ul>

    <h3>2.5 System Abuse</h3>
    <ul>
    ...
    <h2>3. AI Agent Conduct</h2>
    <p>AI agents operating through the Service must:</p>
    <ul>
      <li><strong>Identify as AI:</strong> When asked directly, AI agents must truthfully disclose that they are AI assistants, not humans</li>
      <li><strong>Not impersonate humans:</strong> AI agents must not claim to be a specific real person or pretend to be human</li>
      <li><strong>Respect termination requests:</strong> When a caller asks the AI to stop or end the call, the AI must comply promptly</li>
      <li><strong>Stay within scope:</strong> AI agents must not provide legal, medical, or financial advice unless specifically designed and authorized for that purpose</li>
      <li><strong>Maintain caller ID accuracy:</strong> All calls must display accurate caller ID information</li>
    </ul>
...
export function renderPrivacyPage(): string {
  return legalLayout("Privacy Policy", /* html */ `
    ...
    <ul>
      <li><strong>Communication providers:</strong> We transmit message content to providers (Twilio, Vonage, Resend) you configure, as necessary to deliver your communications. We do not control how these providers handle your data — refer to their respective privacy policies</li>
      <li><strong>AI model providers:</strong> Voice call transcriptions may be processed by AI model providers (such as Anthropic) for generating conversational responses. These providers process data according to their own privacy policies and data handling agreements</li>
    ...
    <p><strong>Provider Disclaimer:</strong> The platform passes data to third-party providers you configure. Each provider has its own terms of service and privacy policy. We recommend reviewing: <a href="https://www.twilio.com/legal/tos" target="_blank">Twilio ToS</a>, <a href="https://resend.com/legal/terms-of-service" target="_blank">Resend ToS</a>, and the terms of any other provider you configure.</p>

    <h2>5. AI Processing</h2>
    <p>The Service uses AI for voice call conversations and optional features. You should be aware:</p>
    <ul>
      <li><strong>Voice Transcriptions:</strong> Voice call audio is transcribed in real-time and may be processed by AI model providers to generate conversational responses</li>
      <li><strong>Data Controller:</strong> For the purposes of data protection law, you (the platform user) are the data controller. The platform operator is the data processor. You determine the purposes and means of processing personal data through the platform</li>
      <li><strong>AI Model Training:</strong> We do not use your communication data to train AI models. However, third-party AI providers may have their own data handling policies</li>
      <li><strong>Opt-out:</strong> You may disable AI features and use the platform purely as communication infrastructure</li>
    </ul>
    ...
    <h2>9. Self-Hosted Deployments</h2>
